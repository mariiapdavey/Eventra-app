import { CART_ADD_ITEM, CART_REMOVE_ITEM, CART_SAVE_PAYMENT_METHOD, CART_SAVE_SHIPPING_ADDRESS, CART_CLEAR } from "../constants/cartConstants"
    ...
    action) => {
        switch (action.type){
            ...
            case CART_CLEAR:
                return {
                    ...state,
                    cartItems: [] //reset cart items to empty
                }
